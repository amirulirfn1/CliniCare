...
<head>
    ...
    <title>Cell Labs ProbiDefendum | CliniCare</title>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-5 col-md-5 col-sm-6">
                                    <div class="white-box text-center"><img src="gambar/cell.jpg" class="img-responsive"></div>
                                </div>
