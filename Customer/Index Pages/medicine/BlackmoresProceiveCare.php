...
<head>
    ...
    <title>Blackmores Proceive Care | CliniCare</title>
        ...
        <section id="services" class="services section-bg">
            <div class="container">
                ...
                <div class="section-title">
                    <h2>Blackmores Proceive Care</h2>
                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-5 col-md-5 col-sm-6">
                                    <div class="white-box text-center"><img src="gambar/blackmores.jpg" class="img-responsive"></div>
                                </div>
