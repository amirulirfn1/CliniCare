<!-- PAGE UNTUK SMOKING CESSATION CAMPAIGN SERVICES -->
...
<html lang="en">
  <head>
    ...
    <title>Smoking Campaign - Services | CliniCare</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Smoking Sessation Campaign - Services </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Services</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Smoking Sessation</li>
                </ol>
              </nav>
            </div>
            <div class="row">
			...
			<div class="col-md-5 grid-margin stretch-card">
                <p>
                     <img 
					 src="../../assets/images/gambar/smokingCare.png"
					 style = "width : 300px">
                    </p>
              </div>
              ...
              <div class="col-md-7 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h6>For current smokers interested in quitting the habit</h6>
                ...
                <div class="card">
                  <div class="card-body">
					...
					<p>
					 ...
					 <img 
					 src="../../assets/images/gambar/smoke3.jpg"
					 style = "width : 200px">
					 <br>
				</div>
