...
<head>
    ...
    <title>Acetylcysteine Sandoz 20 Tablet</title>
        ...
        <section id="services" class="services section-bg">
            <div class="container">
                ...
                <div class="section-title">
                    <h2>Acetylcysteine Sandoz 20 Tablet</h2>
                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-5 col-md-5 col-sm-6">
                                    <div class="white-box text-center"><img src="gambar/Acetylcysteine.jpg" class="img-responsive"></div>
                                </div>
                                <div class="col-lg-7 col-md-7 col-sm-6">
                                    <h4 class="box-title mt-5" style="font-size:30px;">Product description</h4>
                                    <p>Acetylcysteine is used to help prevent or lessen liver damage caused by 
									taking large quantities of acetaminophen (Tylenol). Other than that, help in 
									reduce the viscosity of the secretion from respiratory tract.</p>
                                    <h2 class="labels">
                                        RM38.00
                                    </h2>
                                    ...
                                    <h3 class="box-title mt-5">Direction To Use</h3>
                                    <ul class="list-unstyled">
                                        <li><i class="fa fa-check text-success"></i> Dissolve <strong>1</strong> tablet in a glass with some water and mix it.</li>
                                        <li><i class="fa fa-check text-success"></i> Suitable for <strong>12</strong> years and <strong>above</strong></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
