...
if (isset($_POST['btn-send'])) {
  ...
  if (empty($UserName) || empty($email2) || empty($Subject) || empty($Msg)) {
        ...
        * {
        ...
        <table style="font-family:Cabin,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
            <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 22px; line-height: 35.2px;">Hi, this is ' . $UserName . ' </span></p>
        <p style="font-size: 14px; line-height: 160%;">Feedback: ' . $Msg . '</span></p>
          </div>
