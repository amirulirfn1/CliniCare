...
<body>
          ...
          <div class="col-lg-7 mx-auto text-black">
            <div class="row align-items-center d-flex flex-row">
              ...
              <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                ...
                <a class="text-black font-weight-medium" href="../Customer/sign_in_page/sign_in/signin.php">
  ...
  <!-- container-scroller -->
  <!-- plugins:js -->
  <script src="../Customer/dashboard_page/dashboard_for_customer/assets/vendors/js/vendor.bundle.base.js"></script>
  <!-- endinject -->
  <!-- Plugin js for this page -->
  <!-- End plugin js for this page -->
  <!-- inject:js -->
  <script src="../Customer/dashboard_page/dashboard_for_customer/assets/js/off-canvas.js"></script>
  <script src="../Customer/dashboard_page/dashboard_for_customer/assets/js/hoverable-collapse.js"></script>
  <script src="../Customer/dashboard_page/dashboard_for_customer/assets/js/misc.js"></script>
  <!-- endinject -->
</body>
