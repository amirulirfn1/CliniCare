...
<head>
  ...
  <title>Payment Successful | CliniCare</title>
  <!-- plugins:css -->
...
<body>
  <div class="container-scroller">
    <div class="container-fluid page-body-wrapper full-page-wrapper" style="background-color:#99e6b3;">
      <div class="content-wrapper d-flex align-items-center text-center error-page" style="background-color:#99e6b3;">
        <div class="row flex-grow">
          <div class="col-lg-7 mx-auto text-black">
            <div class="row align-items-center d-flex flex-row">
              <div class="col-lg-6 text-lg-right pr-lg-4">
                <h1 class="display-1 mb-0">
                  <img src="/MasterCliniCare/Customer/Dashboard Page/Dashboard for Customer/assets/images/gambar/success.png" alt="sing up image">
                </h1>
              </div>
              <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                <h2>Thank you for purchasing with CliniCare!</h2>
                <h3 class="font-weight-light">Your payment has been received</h3>
                <br>
                <a class="text-black font-weight-medium" href="/MasterCliniCare/Customer/CustomerHomePage/index.php">
