...
<head>
  ...
  <title>Payment Unsuccessful | CliniCare</title>
  <!-- plugins:css -->
...
<body>
  <div class="container-scroller">
    <div class="ontainer-fluid page-body-wrapper full-page-wrapper" style="background-color:#ff8989;">
          ...
          <div class="col-lg-7 mx-auto text-black">
            <div class="row align-items-center d-flex flex-row">
              ...
              <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                <h2>Unfortunately your transaction has been rejected!</h2>
                <h3 class="font-weight-light">Please try to checkout again.</h3>

                <a class="text-black font-weight-medium" href="/MasterCliniCare/Customer/Index Pages/medicine/viewCart.php">
                  <u>Back to cart</u></a>
              </div>
            </div>
