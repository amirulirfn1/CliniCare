...
<body>
          ...
          <div class="col-lg-7 mx-auto text-black">
            <div class="row align-items-center d-flex flex-row">
              ...
              <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                ...
                <a class="text-black font-weight-medium" href="../Customer/Sign In Page/Sign In/signin.php">
  ...
  <!-- container-scroller -->
  <!-- plugins:js -->
  <script src="../Customer/Dashboard Page/Dashboard for Customer/assets/vendors/js/vendor.bundle.base.js"></script>
  <!-- endinject -->
  <!-- Plugin js for this page -->
  <!-- End plugin js for this page -->
  <!-- inject:js -->
  <script src="../Customer/Dashboard Page/Dashboard for Customer/assets/js/off-canvas.js"></script>
  <script src="../Customer/Dashboard Page/Dashboard for Customer/assets/js/hoverable-collapse.js"></script>
  <script src="../Customer/Dashboard Page/Dashboard for Customer/assets/js/misc.js"></script>
  <!-- endinject -->
</body>
